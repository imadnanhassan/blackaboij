...
export default function Billing () {
    ...
    const [downloadBilling, setDownloadBilling] = useState(false)
    const invoiceRef = useRef();

    // admin invoice download funtion product wise
    const userBillingDownload = (id) => {
      
        setDownloadBilling(true);
            ...
            <div ref={invoiceRef}>
                <div>
                    <div className="flex justify-between items-start pb-4 ">
                        <div>
                            <h1 className="text-2xl font-bold">Billing #1234</h1>
