      ...
      <div className="md:block hidden bg-black  w-full">
        <div className="w-full flex justify-center">
          <div className="max-w-xl">
            <p className="text-[#b1b1b1] py-2">Up to 60% OFF on selected items. With an additional 20%</p>
          </div>
        </div>
        <div
          className=""
          ...
          <div className={`pt-[20px]   w-full ${isSticky ? "fixed  top-0" : ""} bg-black text-white transition-colors duration-500 ease-in-out `}>
            ...
            <div className={`grid grid-cols-3 justify-between items-center px-[50px] pb-[20px]`}>
              ...
              <div className="col-span-1 flex justify-end gap-x-3 relative">
                ...
                <Link >
                  <span style={{ fontSize: `${iconSize}px` }} > <IoBagOutline className="text-white" /><span className="text-[9px] font-bold absolute top-[-3px] text-black px-[4px] bg-white rounded-full right-[25px]">1</span></span>
                </Link>
                <Link >
                  <span style={{ fontSize: `${iconSize}px` }} > <AiOutlineShoppingCart className="text-white" /><span className="text-[9px] font-bold absolute top-[-4px] text-black px-[4px] bg-white rounded-full right-[-3px]">4</span></span>
                </Link>
            ...
            >
              ...
              <Link to="/womens" className={` text-white relative px-[15px] py-[10px] text-[15px]  border-b-2-transparent  group  ${isMenHovered ? 'text-white border-b-2 ' : ''}`}
              ...
              >
                ...
                <Fade direction="left">
                  <ul className={`absolute pl-6 pr-[250px] text-[12px] top-[46px] whitespace-nowrap   ${isMenHovered ? 'block bg-black' : 'hidden'}`}>
                    <ul className="py-[15px] font-semibold"><Link to="/womens">MEN NEW ARRIVALS</Link></ul>
              ...
              <Link to="/accessories">
                <li className={`relative px-[15px] py-[10px] text-white text-[15px] border-b-2-transparent group ${isAccessoriesHovered ? 'text-white  border-b-2' : ''}`}
              ...
              <Link to="/store">
                <li className={`relative px-[15px] py-[10px] text-white text-[15px] border-b-2-transparent group  ${isStoreHovered ? 'text-white  border-b-2' : ''}`}
              ...
              <Link to="/signIn">
                <li className={`relative px-[15px] py-[10px] text-[15px] text-white border-b-2-transparent group ${isSignInHovered ? 'text-white  border-b-2' : ''}`}
              ...
              <Link to="/signUp">
                <li className={`relative px-[15px] py-[10px] text-[15px] text-white border-b-2-transparent group ${isSignUpHovered ? 'text-white  border-b-2' : ''}`}
        ...
        <div className={`grid grid-cols-3 items-center z-50  py-[18px]   px-[20px] font-custom  relative ${isMobileMenuOpen ? "bg-black z-100  " : ""}  `}>
          <div className="   flex  relative">
            ...
            <Link className="pr-[6px] relative">
              <span style={{ fontSize: `18px` }} > <IoBagOutline className="text-white " /><span className="text-[9px] font-bold absolute md:top-[-3px] top-[-4px] text-black px-[4px] bg-white rounded-full right-[1px]">2</span></span>
            </Link>
            <Link className="relative">
              <span style={{ fontSize: `18px` }} > <AiOutlineShoppingCart className="text-white " /><span className="text-[9px] font-bold absolute top-[-4px] text-black px-[4px] bg-white rounded-full right-[-3px]">2</span></span>
            </Link>
