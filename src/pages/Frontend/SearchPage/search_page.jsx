  ...
  return (
    <section>
      ...
      <section className="flex ">
        ...
        <aside className="pl-4 md:pl-10">
          <div className="w-[15vw] h-[100vh] bg-white">
            ...
            <div className="text-sm border border-t-transparent pl-1 md:pl-4 space-y-1 md:space-y-1 md:py-2 py-1 cursor-pointer">
              ...
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Men', 'Tees')} />
                <p>Tees</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Men', 'Hoodies And Sweaters')} />
                <p>Hoodies And Sweaters</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Men', 'Pants')} />
                <p>Pants</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Men', 'Shoes')} />
                <p>Shoes</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Men', 'Outwear')} />
                <p>Outwear</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Men', 'Men Accessories')} />
                <p>Accessories</p>
              </label>
            </div>
            ...
            <div className="text-sm border border-t-transparent pl-1 md:pl-4 space-y-1 md:space-y-1 md:py-2 py-1 cursor-pointer">
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Women', 'Women New Arrivals')} />
                <p>Women New Arrivals</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Women', 'Tees')} />
                <p>Tees</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Women', 'Hoodies And Sweaters')} />
                <p>Hoodies And Sweaters</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Women', 'Pants')}/>
                <p>Pants</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Women', 'Shoes')} />
                <p>Shoes</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Women', 'Outerwear')} />
                <p>Outwear</p>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Women', 'Women Accessories')} />
                <p>Accessories</p>
              </label>
            </div>
            ...
            <div className="border py-1 pl-2 md:pl-4 text-sm font-bold mt-5 md:mt-10">
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="category" className="mr-2" onClick={() => getCategoryData('Accessories', 'New Arrivals')} />
                <p>Accessories</p>
              </label>
            </div>
          </div>
        ...
        <div>
          <section className="grid md:grid-cols-3 xl:grid-cols-4 grid-cols-2 md:gap-[15px] gap-[5px] md:mx-[50px] mx-[20px] md:mb-[50px] mb-[20px]">
