  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        product_title: 'Sunglasses',
        description:
          'Polarized sunglasses with UV protection and anti-glare coating.',
        price: 24.99,
      ...
      },
      {
        product_title: 'Leather Belt',
        description:
          'Stylish leather belt with metal buckle for formal and casual wear.',
        price: 29.99,
        color: ['Black', 'Brown', 'Tan', 'Gray'],
        size: ['S', 'M', 'L', 'XL'],
